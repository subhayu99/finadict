...
def main():
    ...
    if(choice==menu[0]):
        ...
        st.write("*Forgot the ticker symbol? Find it <a href='https://finance.yahoo.com/lookup' style='text-decoration:none; font-size:40px'>here</a>*", unsafe_allow_html=True)
