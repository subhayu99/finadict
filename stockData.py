...
def main():
    ...
    if(choice==menu[0]):
        ...
        st.write("<p style='text-decoration:none; font-size:12px'>Forgot the ticker symbol? Find it <a href='https://finance.yahoo.com/lookup' style='text-decoration:none;'>here</a></p>", unsafe_allow_html=True)
        ...
        st.write(f"<p style='text-decoration:none; font-size:25px'>Showing results for <strong><a href='{comp_info.get('website')}' style='text-decoration:none'>{comp_info.get('longName')}</a></strong></p>", unsafe_allow_html=True)
