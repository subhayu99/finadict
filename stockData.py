...
def main():
    ...
    if(choice==menu[0]):
        ...
        st.write(f"<p style='text-decoration:none; font-size:20px'>Showing results for <strong><a href='{comp_info.get('website')}' style='text-decoration:none; color:black'>{comp_info.get('longName')}</a></strong></p>", unsafe_allow_html=True)
