...
def main():
    ...
    if(choice==menu[0]):
        ...
        st.write("<p style='text-decoration:none; font-size:12px'>Forgot the ticker symbol? Find it <strong><a href='https://finance.yahoo.com/lookup' style='text-decoration:none;'>here</a></strong></p>", unsafe_allow_html=True)
